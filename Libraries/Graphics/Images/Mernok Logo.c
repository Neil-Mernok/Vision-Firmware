// 
//  Image data for MERLogo
// 



#include "Mernok Logo.h"
const uint8_t MERLogo[] =
{
...
const uint8_t MERLogoWidthPixels = 128;
const uint8_t MERLogoHeightPixels = 64;


// Image struct containing data //
const IMAGE_INFO MERLogoINFO =
{
