...
typedef struct
{
	uint8_t* buf;			// buffer used to malloc data to 
	uint8_t* end;			// pointer to the end of the memory region
	uint8_t* put;			// pointer to where data should be put
	uint8_t* get;			// pointer to where data should be retrieved
    int item_size;
    int count;
    int max;
} kpipe;
