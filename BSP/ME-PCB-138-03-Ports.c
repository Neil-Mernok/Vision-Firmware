...
//	GPIO_InitStruct.Pin = ANT_SENSE_PIN | IN0_Pin | IN1_Pin | RTS_Pin;
//	GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
//	GPIO_InitStruct.Pull = GPIO_NOPULL;
//	HAL_GPIO_Init(ANT_SENSE_PORT, &GPIO_InitStruct);
//
...
//	/*Configure GPIO pins : PCPin PCPin PCPin PCPin 
//	 PCPin */
//	GPIO_InitStruct.Pin = LF_CS_PIN | CC_CS_PIN | OUT2_Pin | OUT3_Pin | CAN_DIS_PIN;
//	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
//	GPIO_InitStruct.Pull = GPIO_NOPULL;
//	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
//	HAL_GPIO_Init(CAN_DIS_PORT, &GPIO_InitStruct);
//
...
//	HAL_GPIO_Init(Charging_PORT, &GPIO_InitStruct);
//
//	/*Configure GPIO pins : PCPin PCPin */
//	GPIO_InitStruct.Pin = LF_CLK_IRQ_PIN | LF_INT_Pin;
...
//	GPIO_InitStruct.Pin = CS_EXT2_Pin | CS_EXT1_Pin | VRFID_PIN;
//	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
//	GPIO_InitStruct.Pull = GPIO_NOPULL;
//	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
//	HAL_GPIO_Init(VRFID_PORT, &GPIO_InitStruct);
//
...
//	GPIO_InitStruct.Pull = GPIO_NOPULL;
//	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
//	HAL_GPIO_Init(CAN_term_PORT, &GPIO_InitStruct);
//
...
//
//	/*Configure GPIO pin : PtPin */
//	GPIO_InitStruct.Pin = VersionD_PIN;
//	GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
...
//	
//	DelayUs(1);
//	if(HAL_GPIO_ReadPin(VersionD_PORT, VersionD_PIN) == GPIO_PIN_RESET)
//		board_version = 1;								// this is 182-04
//	if(HAL_GPIO_ReadPin(VersionD2_PORT, VersionD2_PIN) == GPIO_PIN_RESET)
//		board_version = 2;								// this is the new ranging board, 138-03
//	
...
///		Nanotron uIRQ EXTI
///		uIRQ GD0 pins is configured to trigger on both rising and falling edges??
void Config_EXTI_NN_uIRQ(void)
{
	GPIO_InitTypeDef GPIO_InitStruct;
	/*Configure uIRQ pin */
	GPIO_InitStruct.Pin = N_uIRQ_PIN;
	GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	HAL_GPIO_Init(N_uIRQ_PORT, &GPIO_InitStruct);

	/* EXTI interrupt init*/
	HAL_NVIC_SetPriority(N_uIRQ_Channel, 0x3, 0x3);
	HAL_NVIC_EnableIRQ(N_uIRQ_Channel);
}
...
void Config_NN_pins(void)
{
	...
	/*Configure GPIO pin : PtPin */
	GPIO_InitStruct.Pin = NN_CS_PIN;
	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
	HAL_GPIO_Init(NN_CS_PORT, &GPIO_InitStruct);

	/*Configure GPIO pins : PAPin PAPin PAPin PAPin */
	GPIO_InitStruct.Pin = N_PON_R_PIN;
	HAL_GPIO_Init(N_PON_R_PORT, &GPIO_InitStruct);
}
