...
void SPI3_Config(void)
{
	...
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPD;			//---------------------------- this was changed for NTRX chip
...
void SPI_change_mode(SPI_TypeDef* SPIx, int rising)
{
	...
	{ SPI_Direction_2Lines_FullDuplex, SPI_Mode_Master, SPI_DataSize_8b, SPI_CPOL_Low, SPI_CPHA_1Edge, SPI_NSS_Soft, SPI_BaudRatePrescaler_128, SPI_FirstBit_MSB, 7 };
