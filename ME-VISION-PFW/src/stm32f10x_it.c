...
void CAN1_RX0_IRQHandler(void)
{
	...
	if (CAN_GetFlagStatus(CAN1, CAN_FLAG_FMP0))
	{
		...
		CAN_packet_handler(RxMessage.Data, RxMessage.DLC, last, slave_ID);
	}
}
/////////////////////////////////////////////////////////////////////////////////////////
#endif
...
/**
 * @brief  Used for sleep time. milliseconds.
 * @param  None
 * @retval None
 */
